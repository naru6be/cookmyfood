...
public class MenuResourceIT {
    ...
    public void createMenu() throws Exception {
        ...
        assertThat(testMenu.getFoodname()).isEqualTo(DEFAULT_FOODNAME);
        assertThat(testMenu.getCost()).isEqualTo(DEFAULT_COST);
    }
    ...
    public void updateMenu() throws Exception {
        ...
        Menu testMenu = menuList.get(menuList.size() - 1);
        assertThat(testMenu.getFoodname()).isEqualTo(UPDATED_FOODNAME);
        assertThat(testMenu.getCost()).isEqualTo(UPDATED_COST);
    }
